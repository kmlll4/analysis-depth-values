...
def run(args, weight_mean, weight_std, data_dir, pig_id, target_weight, target_bbox, output_dir):
    ...
    with open(os.path.join(output_dir, pig_id + "_sre_v2.csv"), "w", newline="") as file_:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mass_model_path", type=str, default="/workspace/mass/ecopork-main/mass_models/epoch-915_val_MRE-0.0405_val_narrow_MRE-0.0383.pth")  # ori
    ...
    for target_dir in dir_list:
        ...
        run(args, weight_mean, weight_std, data_dir, pig_id, target_weight, target_bbox, output_dir)
